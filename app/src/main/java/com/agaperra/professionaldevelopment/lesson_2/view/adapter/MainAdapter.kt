package com.agaperra.professionaldevelopment.lesson_2.view.adapter
...
import com.agaperra.professionaldevelopment.lesson_2.utils.convertMeaningsToString
    ...
    inner class RecyclerItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(data: DataModel) {
            if (layoutPosition != RecyclerView.NO_POSITION) {
                ...
                itemView.description.text = convertMeaningsToString(data.meanings!!)
